...
namespace FiapSmartCity.Repository
{
    public class TipoProdutoRepositoryEF
    {
        ...
        private TipoProdutoEF tipoProdutoEF;
        ...
        public void Inserir(TipoProdutoEF tipoProdutoEF)
        {
            context.TipoProdutoEF.Add(tipoProdutoEF);
            context.SaveChanges();
        }

        public void Alterar(TipoProdutoEF tipoProdutoEF)
        {
            context.TipoProdutoEF.Update(tipoProdutoEF);
            context.SaveChanges();
        }
        ...
        public void Excluir(int id)
        {
            ...
            context.TipoProdutoEF.Remove(tipoProdutoEF);
            context.SaveChanges();
        }
